...
export default function DashboardLayout({
  ...
  // 🔹 Permissions dynamiques basées sur Firestore
  const userRole = user.role || 'Membre'; // récupérer un rôle stocké dans Firestore si dispo
...
export default function DashboardLayout({
  ...
  const userRole = 'Modérateur'; // This would come from user session in a real app
  const isFemale = true; // This would also come from the user's profile
  const isStudent = false; // This too
          ...
          <Sidebar collapsible="icon">
            ...
            <SidebarContent>
              <SidebarMenu>
                ...
                {(userRole === 'Administrateur' || userRole === 'Modérateur') && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <Link href="/dashboard/administration">
                        <Shield />
                ...
                <SidebarMenuItem>
                 ...
                 {canSeeGirlsOutings && (<SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <Link href="/dashboard/girls-outings">
                        <Heart />
                        <span>Sorties entre filles</span>
                   ...
                   {canSeeStudentOutings && (<SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <Link href="/dashboard/student-outings">
                        <School />
                        <span>Sorties étudiantes</span>
